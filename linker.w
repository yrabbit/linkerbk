...
секцию. На практике для таких вещей как адреса векторов прерываний или регистров
устройств
или еще чего-нибудь неизменного проще и правильней использовать прямое
присваивание символов как в следующем примере.
